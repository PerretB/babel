(function() {
  ...
  /**
  * Ce module regroupe toutes les fonctionnalitées permettant de gérer les
  * arbres syntaxiques.
  */
  ...
  */
  ...
  /**
  * AST, un noeud particulier.
  */
  module.factory('AST', ["$ASTRequestParse", "Node", function($ASTRequestParse, Node) {
    ...
    AST.prototype.request = function(request) {
      return $ASTRequestParse(request);
    };
